...
dcp44_sources = mkdict(dcp43_sources, 479, mkdelta([
    # @formatter:off
    ...
    mksrc('bigquery', 'datarepo-c6ed9e98', 'hca_prod_35d5b0573daf4ccd8112196194598893__20240903_dcp2_20241118_dcp44', ma),  # noqa E501
